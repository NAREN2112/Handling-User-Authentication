...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("ragul");
		assertEquals(testUser.getName(),"ragul");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("ragul@gmail.com");
		assertEquals(testUser.getEmail(),"ragul@gmail.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("ragul","ragul@gmail.com","ragul@123");
		
		User checkUser = new User();
		checkUser.setName("ragul");
		checkUser.setEmail("ragul@gmail.com");
		checkUser.setPassword("ragul@123");
